...
win32-msvc {
    ...
    base_path = $$system_path($$absolute_path($$clean_path($${B4X_DEP_PATH})))
    !exists($${base_path}) {
        error("\"$${base_path}\" is NOT existed.")
    }
    ...
    libDir_path = $$system_path($${base_path}/bin)
    !exists($${libDir_path}) {
        error("\"$${libDir_path}\" is NOT existed.")
    }

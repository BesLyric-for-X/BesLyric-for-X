...
QWidget *SuDonation::getUnitWidget(QWidget *parent)
{
    ...
    label2->setText(tr("<p style='line-height:130%'>也是在此背景下，<a style='color:#666666;' href='https://github.com/BesLyric-for-X/BesLyric-for-X'>BesLyric-for-X</a> 应运而生。新版本使用了跨平台框架实现，支持 Windows、Linux (Debian)、Mac OS三大操作系统。"
